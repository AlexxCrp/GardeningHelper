...
import { UpdateGardenRequestDTO } from "../Models/API/DTOs/Auto/Request/updateGardenRequestDTO";
...
class GardenServiceClass {
  ...
  public async updateGarden(request: UpdateGardenRequestDTO): Promise<UserGardenResponseDTO> {
    try {
